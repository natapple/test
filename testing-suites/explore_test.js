var ExploreTest = function(assert) {
    ...
    var testSeries = function(casper, test, start) {
        ...
        casper.then(function() {
            if(assert) test.assertElementCount(".single_work", 12, "Found 12 tapes on explore page");
        });
                ...
                casper.then(function() {
                    ...
                    for(var j = 2 ; j <= pages + 1; j++) {
                        (function(i) {
                            ...
                            casper.then(function() {
                                if(assert) test.assertElementCount(".single_work", 12, "Found 12 tapes on explore page " + i);
                            });
                            casper.then(function() {
